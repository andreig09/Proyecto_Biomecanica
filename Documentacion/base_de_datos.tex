...
Con este fin se ha diseñado e implementado la estructura de datos de la figura (XXXXXX).
La misma permite almacenar tanto la información de ground truth como la generada a la hora de  trabajar en las etapas de análisis de video. Se han implementado funciones de acceso de entrada y salida en Matlab, así como varias herramientas de gestión. Que permiten entre otras cosas blablablabla
