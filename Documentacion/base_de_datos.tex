...
Ya se dispone de la secuencia de movimiento en el entorno virtual de Blender, lo que resta es renderizar dicha secuencia sobre las cámaras del laboratorio. Para ello se implementó un código en python automatiza todo el proceso, dispone los videos obtenidos en cada render con nombres y ubicaciónes predefinidas en la base de datos a generar y genera un código Matlab con la información ground truth de cada cámara. 
 
 Para el ajuste se utiliza 
...
\paragraph{Exportación del Ground truth} 
