...
La captura de movimiento (Mocap), es un proceso bastante popular que permite generar animaciones humanas. Relevante en la mayoría de las bases de datos relevadas, incluso aquellas de análisis óptico, se utiliza  
