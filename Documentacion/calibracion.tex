...
Algunas soluciones comerciales, como por ejemplo Vicon(referencia), utiliza como objeto de calibración una vara con leds, ver figura \ref{vicon}. 

\begin{figure}[H]
        \centering
        
        \subfloat{\includegraphics[scale=1.8]{img/calibracion/vicon1.png}\label{peladoOriginalintro}}
        \subfloat{\includegraphics[scale=0.08]{img/calibracion/vicon2.jpg}\label{peladocirculosintro}}
