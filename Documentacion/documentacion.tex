...
\usepackage{multirow} %paquete que sirve para la generación de tablas, en especial con multiples filas
\usepackage[table,xcdraw]{xcolor} %para que las celdas de las tablas puedan ser de colores, (ahora Gonzalo puede usar rosadito)
\usepackage{booktabs} %para tablas bonitas tiene unos comando chevere
