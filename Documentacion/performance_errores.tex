...
En la tabla \ref{error_captura_marcha_63_64_camaras}, se presentan los resultados de una combinacion de camaras usualemente ensayado en la bibliografia relevada ( \cite{gross2001cmu} , \cite{humaneva} ). El mismo consiste en no tener todas las camaras espacialmente distribuidas de forma similar como en el conjunto 6.1 o 6.2, sino tener un conjunto de 2 agrupadas y una tercer separada por cada lado, y cada lado tiene su conjunto de 2 camaras del lado opuesto. Combinaciones de camaras con esta geometria presentan resultados notoriamente mejores a las otras combinaciones de 6 camaras ensayadas anteriormente.
...
Para el caso de todas las camaras, o dos camaras por esquina cuyos resultados son relevados en la tabla  \ref{error_captura_libre_15_8_camaras} , se confirman los resultados obtenidos en la captura de marcha de buenos resultados para todos los marcadores.
