...
Finalmente, los conjuntos de 5 cámaras ( tabla \ref{error_captura_marcha_5_camaras} ) son solidarios a los conjuntos de 4 cámaras ( tabla \ref{error_captura_marcha_4_camaras} ), donde solo los marcadores de los pies, hombros y cabeza logran buenos resultados. La única diferencia entre ambos conjuntos, es la cámara superior.
