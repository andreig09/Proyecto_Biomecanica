...
\begin{figure}[!ht]
   \centering 
    \subfloat[Vista derecha]{\includegraphics[scale=0.50]{img/Reconstruccion/22_derecha.png}}
    \subfloat[Vista de atrás]{\includegraphics[scale=0.50]{img/Reconstruccion/22_atras.png}}\hspace{2cm}
    \subfloat[Vista izquierda]{\includegraphics[scale=0.50]{img/Reconstruccion/22_izquierda.png}}
