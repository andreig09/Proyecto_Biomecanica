...
El primero de ellos evalúa cada cámara respecto a todas las restantes y el segundo considera la disposición de las cámaras en el espacio y empareja las cámaras adyacentes de manera consecutiva. Ver la figura \ref{img_asociacion}. Más adelante se demuestra que este segundo procedimiento da mejores resultados.ACA SE DEBE REFERENCIAR BIEN DONDE ESTA ESA DEMOSTRACION \\
 ...
 \begin{figure}[!ht]
   \centering 
    ...
    \subfloat[Cada cámara con su adyacente]{\includegraphics[scale=0.13]{img/Reconstruccion/enlazado_adyacente}}
...
\cline{3-6}
                                                                              &                                                       & \multicolumn{2}{l|}{Algoritmo Viejo}                                                                                             & \multicolumn{2}{l|}{Algoritmo Nuevo}                                                                                            \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Marker\\ Ground\end{tabular}} & \begin{tabular}[c]{@{}l@{}}Name\\ Ground\end{tabular} & \begin{tabular}[c]{@{}l@{}}Error \\ Promedio\\ (cm)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Percentil\\ 99\% (cm)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Error\\ Promedio\\ (cm)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Percentil\\ 99\% (cm)\end{tabular} \\ \hline
...
\multicolumn{1}{l|}{}                                                         & Secuencia                                             & 0.38556                                                          & 1.7907                                                        & 0.35686                                                         & 0.81266                                                       \\ \cline{2-6} 
\end{tabular}
\end{table}
...
\subsection{Reconstrucción de marcadores a partir de secuencias reales}
