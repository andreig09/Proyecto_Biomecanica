...
\begin{figure}[H]
        \hspace{-1cm}
        \subfloat[Original]{\includegraphics[scale=0.53]{img/abel.png}\label{abelreal} 
         } \hspace{0.1cm}        
       \subfloat[Histograma]{\includegraphics[scale=0.65]{img/hist_abel.png}\label{histabel}}
