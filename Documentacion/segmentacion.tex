...
Dado que la segmentación es la parte más compleja de este bloque, se detallará su estado del arte. Se realizó una revisión comenzando desde los algorítmos más básicos, hasta encontrar alguno que cubra todos los requerimientos del sistema.
 ...
 Como se mencionó anteriormente, existen varios métodos para realizar la segmentación, en particular los algoritmos para tratar imágenes monocromáticas generalmente se clasifican en dos grupos basados en la intensidad de los píxeles: discontinuidad y similaridad. 
...
Por otro lado, C++ es un lenguaje de una complejidad superior a otros disponibles para procesar imágenes, por lo que implementar el algoritmo con el mismo implicó mayor esfuerzo (por ejemplo, en el manejo de la memoria) que de haber utilizado un lenguaje que que trabaje a más alto nivel.
...
\begin{figure}[H]
        \centering
        \subfloat[Captura original de una secuencia real.]{\includegraphics[scale=0.34]{img/abel_original_video.png}\label{abelvideo}}\hspace{5 mm}
        \subfloat[Imagen filtrada con el umbral de Otsu.]{\includegraphics[scale=0.34]{img/abel_original_filtro.png}\label{abelfiltro}}
...
\begin{figure}[H]
        \centering
        \subfloat[Captura con el fondo extraído.]{\includegraphics[scale=0.34]{img/abel_sf_video.png}\label{abelvideosf}}\hspace{5 mm}
        \subfloat[Video Filtrado.]{\includegraphics[scale=0.34]{img/abel_sf_filtro.png}\label{abelfiltrosf}}
...
\begin{figure}[H]
        \centering
        \subfloat[Blobs detectados.]{\includegraphics[scale=0.34]{img/abel_original_blobs.png}\label{abelblobs}}\hspace{5 mm}
        \subfloat[Circulos detectados.]{\includegraphics[scale=0.34]{img/abel_original_circulos.png}\label{abelcirculos}}
...
\begin{figure}[H]
        \centering
        \subfloat[Blobs detectados.]{\includegraphics[scale=0.34]{img/abel_sf_blobs.png}\label{abelblobssf}}\hspace{5 mm}
        \subfloat[Círculos detectados.]{\includegraphics[scale=0.34]{img/absel_sf_circulos.png}\label{abelcirculossf}}
...
\begin{figure}[H]
        \centering
        \subfloat[Blobs detectados.]{\includegraphics[scale=0.34]{img/abel_sf_blobs_2.png}\label{abelblobssf2}}\hspace{5 mm}
        \subfloat[Circulos detectados.]{\includegraphics[scale=0.34]{img/abel_sf_circulos_2.png}\label{abelcirculossf2}}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.8]{img/imagen_segmentacion_cam7_8_07_100_200.png}
\end{center}
\vspace{-7mm}
