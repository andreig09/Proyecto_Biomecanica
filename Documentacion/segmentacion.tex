...
En la Figura \ref{gonz2} se observaba una imagen de 6x6 píxeles y su representación matricial. Al aplicar la máscara de Sobel a la matriz de esta imagen, se detecta la transición entre los cuatro niveles de gris mientras que se igualan los niveles constantes. En la Figura \ref{gonz6} se pueden observar estos resultados.
...
La idea inicial fue realizar la totalidad del sistema en C++, sin embargo, por razones prácticas se decidió implementar los bloques de reconstrucción, calibración y tracking en \emph{Matlab}.
