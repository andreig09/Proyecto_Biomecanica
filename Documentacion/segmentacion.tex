...
\hspace{-0.6cm}donde $P_1$ y $P_2$ son las probabilidades de que un píxel sea asignado a la clase $1$ o $2$ respectivamente, $m_1$ y $m_2$ son las medias de las intensidades de cada una de estas clases. Además, $m(k)$ es la media (intensidad promedio) acumulada  hasta el nivel $k$ y $m_G$ es la intensidad media (intensidad global promedio) de la imagen en su totalidad
\begin{equation}
m(k) = \sum_{i=0}^{k}ip_i
...
\hspace{-0.6cm}y considerando que $k$ es el umbral que separa la clase $1$ de la clase $2$, $P_1$ puede escribirse como
