...
\end{center}
\caption{}
\label{Resultado de Aplicar el Seguimiento de marcadores a una vista 2D sin reproyeccion de puntos reconstruidos. Verde, las trayectorias que se enlazaron completamente, Azul los puntos segmentados en la vista 2D de la camara 07 de la captura sintetica}
\end{figure}
