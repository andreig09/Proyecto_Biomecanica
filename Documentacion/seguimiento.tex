...
Se establece un umbral a partir del estudio de la distribucion de la aceleracion de cada marcador para encontrar la aceleracion que presenta un salto abrupto, 

\begin{figure}[hbt]
\begin{center}
\includegraphics[scale=0.6]{img/Tracking/03_Distribucion_Aceleracion_Marker_13_8_07_100_200.png}
\end{center}
\caption{Funcion de distribucion de la Aceleracion, }
