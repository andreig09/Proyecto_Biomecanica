function X = get_markers_in_frame(varargin)
...
% structure = skeleton;
% %structure = cam(2);
% X = get_markers_in_frame(structure, 1) %devuelve las coordenadas de todos los marcadores en el frame 1 de structure
% X = get_markers_in_frame(structure, 1, 'coord') %devuelve las coordenadas de todos los marcadores en el frame 1 de structure
% X = get_markers_in_frame(structure, 1, 'name') %devuelve un cell string con los nombres de todos los marcadores en el frame 1 de structure
% X = get_markers_in_frame(structure, 1, 'state') %devuelve un vector con los estados de  todos los marcadores en el frame 1 de structure
% X = get_markers_in_frame(structure, 1, 'source_cam') %devuelve un vector con las camaras fuente de todos los marcadores en el frame 1 de structure
% X = get_markers_in_frame(structure, 1, [2 3]) %devuelve las coordenadas de los marcadores 2 y 3 del frame 1 de structure
% X = get_markers_in_frame(structure, 1, [2, 3], 'coord') %devuelve las coordenadas de los marcadores 2 y 3 del frame 1 de structure
% X = get_markers_in_frame(structure, 1, [2, 3], 'name') %devuelve un cell string con los nombres de los marcadores 2 y 3 del frame 1 de structure
% X = get_markers_in_frame(structure, 1, [2, 3], 'state') %devuelve un vector con los estados de los marcadores 2 y 3 del frame 1 de structure
% X = get_markers_in_frame(structure, 1,  [2, 3], 'source_cam') %devuelve un vector con las camaras fuente de los marcadores 2 y 3 del frame 1 de structure
