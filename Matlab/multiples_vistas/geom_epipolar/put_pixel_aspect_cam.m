function cam = put_pixel_aspect_cam(pixel_aspect, cam)
% Funcion que actualiza "cam.info.pixel_aspect" con los valores de "pixel_aspect"
%info = struct(...
...
%     );
cam.info.pixel_aspect=pixel_aspect;
end