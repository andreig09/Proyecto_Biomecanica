function cam = put_resolution_cam(resolution, cam)
% Funcion que actualiza "cam.info.resolution" con los valores de "resolution"
%info = struct(...
%     'resolution',               nan(3, 3), ...%matriz de rotación
...
%     );
cam.info.resolution=resolution;
end