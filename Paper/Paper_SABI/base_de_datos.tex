...
% a partir de 
con cámaras situadas en un entorno 3D cerrado, previamente acondicionado. Así como también contar con el correspondiente ground truth 2D y 3D\footnote{Por ground truth se entiende como aquella información que se considera verdadera, en este caso referida a las trayectorias 2D y 3D del movimiento de interés. Las pruebas de performance de las distintas partes del sistema son contrastadas respecto a dicho ground truth.} de los datos de movimiento disponibles y la información de calibración de las cámaras utilizadas para efectuar las capturas.
\vspace{-0.3cm} 
