...
\begin{figure}[ht!]
      \centering
        \subfloat[]{\includegraphics[scale=0.10]{imagenes/abel_original_video.png}\label{abelvideo}}\hspace{1 mm}
        \subfloat[]{\includegraphics[scale=0.10]{imagenes/abel_original_filtro.png}\label{abelfiltro}}

        \subfloat[]{\includegraphics[scale=0.07]{imagenes/orig.png}\label{abelvideo2}}\hspace{1 mm}
        \subfloat[]{\includegraphics[scale=0.07]{imagenes/filtr.png}\label{abelfiltro2}}\hspace{1 mm}
        \subfloat[]{\includegraphics[scale=0.07]{imagenes/detect.png}\label{abeldetect}}
