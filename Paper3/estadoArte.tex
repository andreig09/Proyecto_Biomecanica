...
Se realizó una revisión de la bibliografía disponible referida a la captura de movimiento. Se encontraron diversos artículos que mencionan hacen una revision de las distintas técnicas que se encuentran. Dado que nuestra búsqueda estaba centrada en el desarrollo de un sistema de buena precisión pero además accesible, orientamos la búsqueda hacia sistemas que emplean cámaras ópticas y marcadores, los cuales, según algunos artículos este método a pesar de los avances en los métodos sin marcadores sigue presentando mayores niveles de precision. A este respecto encontramos que no habían muchos artículos que resumieran el estado del arte en particular de este método de captura.

Si en cambio encontramos articulos que describen implementaciones de sistemas parciales o completos con este método. Esta bibliografía permitió tomar conocer los procesos principales con los que debe contar un sistema de estas características. estos procesos en general son \emph{Adquisición}, \emph{Calibración}, \emph{Detección de marcadores}, \emph{Reconstrucción} y \emph{Seguimiento}. Por tanto la bśuqeda se orientó a artículos más específicos a cada una de  estos procesos. En dicha etapa se realiza una clasificación de los documentos de acuerdo a la relevancia que prestan y se definen los métodos que posteriormente se utilizaron para implementar los distintos procesos que componen el sistema.
