...
% Val2str subfunction "aumento de resolucion" by M. Ramos, 24-9-2014
...
elseif (isnumeric(val))
    %val = num2str(val);
     val = num2str(val, '%30.13g');%MODIFICACION QUE PERMITE AUMENTAR LA RESOLUCION DE LOS NUMEROS GUARDADOS
else
    succes = false;
end
if (ischar(val))
